...
import { EmailNew } from "app/emails/emailTemplate";

const resend = new Resend("re_ZyZLcuXt_GJCJdaqos4Y9QMXg9ovnTD2X");

const emailHtml = await render(<EmailNew url={""} />);
...
const CreateCampaingForm: React.FC<CreateCampaingFormProps> = ({
  activate,
  setActivate,
}) => {
